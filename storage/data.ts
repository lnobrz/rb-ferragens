export const paragraphs = {
  indexCover:
    "Qualidade, preço acessível e entrega rápida: sua solução em ferragens.",
  indexProductSession:
    "Encontre as melhores ferragens para o seu projeto. Qualidade, variedade e preço justo.",
  indexAdvantagesSection:
    "Benefícios em escolher nossa empresa: qualidade, preços competitivos e entrega rápida. Faça a escolha certa!",
};
...
export const products = [
  {
    ...
    name: "arames",
    shortDescription:
      "Versatilidade e resistência para diversas aplicações. Ideal para cercas, amarrações e projetos de artesanato.",
    fullDescription:
  ...
  },
  {
    ...
    name: "colunas",
    shortDescription:
      "Suporte robusto e confiável para estruturas verticais. Perfeitas para construções comerciais e residenciais de alto padrão.",
    fullDescription:
  ...
  },
  {
    ...
    name: "malhas",
    shortDescription:
      "Reforço e segurança em projetos de concreto. Ideais para lajes, pisos e revestimentos, garantindo resistência e estabilidade.",
    fullDescription:
  ...
  },
  {
    ...
    name: "radiers",
    shortDescription:
      "Base sólida e resistente para construções. Perfeitos para suportar cargas pesadas e distribuir o peso de forma eficiente.",
    fullDescription:
  ...
  },
  {
    ...
    name: "treliças",
    shortDescription:
      "Estruturas leves e versáteis para projetos de cobertura. Proporcionam estabilidade e suporte para telhados e estruturas metálicas.",
    fullDescription:
  ...
  },
  {
    ...
    name: "vergalhões",
    shortDescription:
      "Resistência e durabilidade em um só produto. Perfeitos para estruturas de concreto armado e construções de alta qualidade.",
    fullDescription:
  ...
  },
  {
    ...
    name: "vigas",
    shortDescription:
      "Elementos estruturais essenciais para sustentação. Ideais para construções de médio e grande porte, garantindo resistência e estabilidade.",
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Durabilidade e resistência à corrosão. Perfeitos para sistemas de encanamento, estruturas metálicas e projetos industriais.",
    fullDescription:
